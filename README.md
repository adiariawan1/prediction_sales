...
Visualisasi: Plot 84 hari terakhir Anda menunjukkan bahwa model berhasil menangkap tren umum dan seasonality mingguan.

untuk data set = https://www.kaggle.com/c/store-sales-time-series-forecasting/data?select=train.csv
